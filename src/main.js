...
exports.GUILD = ({ url }) => {
    ...
    return new Promise((resolve, reject) => {
        axios(config).then(data => {
            ...
            // WLC SCREEN
            if (req.guild.welcome_screen) req.guild.welcome_screen = {
                description: req.guild.welcome_screen.description,
                WLCChannels: req.guild.welcome_screen.welcome_channels,
            }; else req.guild.welcome_screen = {
                description: null,
                WLCChannels: null
            }
            resolve({
